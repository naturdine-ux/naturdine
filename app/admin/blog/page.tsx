    ...
    <div className="p-6 md:p-8">
      ...
      <div className="bg-white rounded-2xl border border-[#EDE8DF] overflow-hidden">
        ...
        <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-[#F8F4EE] border-b border-[#EDE8DF]">
          <div className="col-span-5 text-xs font-bold uppercase tracking-widest text-[#6B6560]">Title</div>
          ...
          <div className="col-span-2 text-xs font-bold uppercase tracking-widest text-[#6B6560]">Status</div>
        ...
        {posts?.map((post) => (
          ...
          >
            ...
            <div className="col-span-2 text-sm text-[#6B6560]">
              {post.read_time}
            </div>
            <div className="col-span-2">
            ...
            <div className="col-span-1 flex items-center gap-3">
              <Link
                href={`/blog/${post.slug}`}
                target="_blank"
                className="text-xs text-[#6B6560] hover:text-[#2C4A1E] transition-colors"
              >
                View
              </Link>
            </div>
        ...
        {posts?.length === 0 && (
          <div className="px-6 py-12 text-center text-sm text-[#6B6560]">
            No blog posts yet.{" "}
            <Link href="/admin/blog/new" className="text-[#2C4A1E] font-semibold hover:underline">
              Add your first post →
            </Link>
          </div>
        )}
